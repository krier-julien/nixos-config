{pkgs, ...}: {
  home.packages = with pkgs; [
    # ── Communications ──────────────────────────────────────────────────
    # The official client, after trying both mods. Vesktop and Equibop are
    # nicer to theme, but they capture screen-share audio through venmic/
    # equimic instead of Electron's own "System Audio", and neither survived
    # contact with the OBS→Discord path this machine exists for. See
    # ./obs.nix for what actually went wrong.
    discord
